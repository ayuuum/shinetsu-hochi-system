...
const authMailNotes = [
    "業務アラートのメール通知は使いません。",
    "新規ユーザーは管理者が初期パスワードを設定し、本人に直接お伝えします。",
    "パスワード再設定メールは、本人がログイン画面から再設定する場合に使用します。",
    "メールが届かない場合は、管理者によるパスワード再発行、または迷惑メールフォルダ・リンクの有効期限を確認してください。",
];
                ...
                <article className="rounded-[32px] bg-white p-6 shadow-[0_24px_80px_rgba(31,42,36,0.12)] md:p-10 print:rounded-none print:p-0 print:shadow-none">
                    ...
                    <section className="manual-section">
                        ...
                        <div className="mt-5 rounded-2xl bg-[#f4f1ea] p-4">
                            ...
                            <ol>
                                <li>通常は管理者に連絡し、ユーザー管理画面からパスワードを再発行してもらいます。</li>
                                <li>自分で再設定する場合は、ログイン画面の「パスワードを忘れた場合」を押します。</li>
                                <li>登録済みメールアドレスを入力し、届いたメールのリンクから新しいパスワードを設定します。</li>
                            </ol>
                        </div>
                    </section>
                    ...
                    <section className="manual-section">
                        ...
                        <p>
                            新規ユーザーは、管理者が「ユーザー管理」から追加します。
                            管理者が初期パスワードを設定し、表示されたログイン情報を本人に直接お伝えします。
                        </p>
                        <ul>
