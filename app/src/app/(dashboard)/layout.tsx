...
export default async function DashboardLayout({
    ...
    return (
        ...
        >
            <SidebarProvider>
                <AppSidebar />
                <main className="flex flex-1 flex-col min-w-0 overflow-x-hidden bg-[radial-gradient(circle_at_top,rgba(49,78,110,0.07),transparent_30%),linear-gradient(180deg,rgba(250,251,253,0.97),rgba(243,246,249,1))] print:bg-white pb-[calc(4rem+env(safe-area-inset-bottom))] md:pb-0">
                    <DashboardHeader />
